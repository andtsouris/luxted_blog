...
def convert_markdown_to_html(markdown_file):
    ...
    <style>
        ...
        .nav-five {{ transition: color 0.4s; }}
        html.dark .nav-five {{ color: var(--yellow); }}
        .dark-toggle {{
        ...
        h3 {{ font-size: 1.75rem !important; font-weight: 600 !important; margin-top: 1.5rem !important; margin-bottom: 1rem !important; font-family: 'Lexend', serif !important; }}
    ...
    <body>
        ...
        <nav class="site-nav">
            <div class="nav-inner">
                <a href="../index.html" class="blog-title">Luxted<span class="title-dot"></span><span class="nav-five">5</span></a>
                <button class="dark-toggle" onclick="toggleDarkMode()" aria-label="Toggle dark mode">
                    ...
                    <span class="icon-sun"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="5"/><line x1="12" y1="1" x2="12" y2="3"/><line x1="12" y1="21" x2="12" y2="23"/><line x1="4.22" y1="4.22" x2="5.64" y2="5.64"/><line x1="18.36" y1="18.36" x2="19.78" y2="19.78"/><line x1="1" y1="12" x2="3" y2="12"/><line x1="21" y1="12" x2="23" y2="12"/><line x1="4.22" y1="19.78" x2="5.64" y2="18.36"/><line x1="18.36" y1="5.64" x2="19.78" y2="4.22"/></svg></span>
                </button>
            </div>
        </nav>
        ...
        <footer>
            <div class="max-w-4xl mx-auto px-4 py-8">
                <div class="text-center">
                    <p>&copy; 2026 Luxted.5 Blog. All rights reserved.</p>
                </div>
            </div>
        </footer>
